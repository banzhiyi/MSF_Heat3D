...
class Conv_Classifier(nn.Module):
    ...
    def forward(self, x):
        ...
        # 🛠️ 修复: 使用 reshape 替代 view，以处理非连续内存张量
        # 原代码: x = x.view(-1, self.feature_size)
...
class DSNet(nn.Module):
    ...
    # 修复 1: 添加默认参数 basic_cls_name='conv2d' 以适配 main.py 的调用
    def __init__(self, band, num_classes, patch_size, basic_cls_name='conv2d'):
    ...
    def forward(self, x):
        ...
        # 修复 2: 仅返回 output_cls 以适配 main.py 中的 generic loss 计算
        # 原代码: return re_unmix_nonlinear, re_unmix, output_cls
        return output_cls