...
parser.add_argument('--PCA_band', type=int, default=50, help='pca_components')#ip70 sa 70 hu 50
parser.add_argument('--learning_rate', type=float, default=5e-4, help='learning rate')
parser.add_argument('--weight_decay', type=float, default=0, help='weight_decay')
parser.add_argument('--gamma', type=float, default=0.9, help='gamma')

parser.add_argument('--gpu_id', default='0', help='gpu id')
parser.add_argument('--seed', type=int, default=8, help='number of seed')
...
for run in range(args.num_run):
    ...
    # optimizer   # scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[args.epoches*0.5,args.epoches*0.75,args.epoches*0.9],gamma=0.2)  # learning rate decay
    # -------------------------------------------------------------------------------
