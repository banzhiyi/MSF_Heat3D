...
parser.add_argument('--dataset', choices=['Indian', 'Pavia', 'Houston', 'WHU_Hi_LongKou'], default='Indian',
                    help='dataset to use')
...
x_train, x_test = train_and_test_data(mirror_image, band, total_pos_train, total_pos_test, total_pos_true,
                                      patch=args.patches)
